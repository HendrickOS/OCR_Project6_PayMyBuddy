package com.example.PayMyBuddy.security.jwt;
...
public class JwtUtil {
	...
	public static String generateToken(String subject, String signingKey, int validity, Set<String> roles,
			Map<String, String> addPayload) throws Exception {
		return generateToken(subject, signingKey, validity, roles, addPayload, null);
	}

	public static String generateToken(String subject, String signingKey, int validity, Set<String> roles,
			Map<String, String> addPayload, String xsrfToken) throws Exception {
		...
		JwtBuilder builder = Jwts.builder().setSubject(subject).setIssuer(ISSUER).setIssuedAt(iat).setExpiration(exp)
				.claim(XSRF_TOKEN, xsrfToken).signWith(SignatureAlgorithm.HS256, key);
	...
	public static String getSubjectFromAuthHeader(String authHeader, String signingKey, String xsrfToken)
			throws Exception {
	...
	private static String getSubject(String token, String signingKey, String xsrfToken) throws Exception {
		...
		/*
		 * String key = Base64Utils.encode(signingKey); LOG.debug("token: " + token);
	...
	public static String getSubjectFromCookie(HttpServletRequest request, String signingKey, String xsrfToken)
			throws Exception {
		return getSubjectFromCookie(request, signingKey, DEFAULT_COOKIE_NAME, xsrfToken);
	}

	public static String getSubjectFromCookie(HttpServletRequest request, String signingKey, String jwtCookieName,
